...
public interface Query {
	 ...
	 * @return
	 */
	public Set<Term> getDistVarsForType(final VarType queryType);
	 ...
	 * @param atom
	 */
	public void addDistVar(final Term a, final VarType type);
	 ...
	 * @param atom
	 */
	public void addResultVar(final Term a);
	 ...
	 * @return
	 */
	public Term rollUpTo(final Term distVar,
			final Collection<Term> avoidList, final boolean stopOnConstants);
